# PowerShell script: build, copy, and distribute latest APK to Firebase testers
# 1. Runs flutter build
# 2. Finds and copies latest APK
# 3. Uploads to Firebase App Distribution (testers group)
...
# Step 2: Find and copy latest APK
$apkDirs = @(
